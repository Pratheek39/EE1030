...
\begin{enumerate}
    \item If $c_r$ stands for $^nC_r$ ,the the sum of the series $\frac{2\brak{\frac{n}{2}!}\brak{\frac{n}{2}!}}{n!}\sbrak{C_0^2-2C_1^2+3C_2^2-\dots+\brak{-1}^n\brak{n+1}C_n^2}$, where n is an even positive integer is equal to{{$\hfill\brak{1992-2Marks}$}}
\begin{enumerate}
\begin{multicols}{2}
\item 0
