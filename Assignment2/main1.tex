...
\begin{enumerate}
    \item If $y$=$f{\brak{\frac{2x+1}{x^2+1}}}$ and $f'\brak{x}$ =$sin{x}^2$, then $\frac{dy}{dx}$ = \dots\dots\hfill \brak{1982-2 Marks} 
...
\item If $f(x)=\log_{x}\brak{\ln{x}}$,then $f'\brak{x}$ at $x=e$ is\dots\dots \hfill \brak{1982-2 Marks} 
